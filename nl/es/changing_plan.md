...
Puede cambiar su plan de servicios en {{site.data.keyword.Bluemix}} si los cambios de plan están habilitados para dicho servicio.
...
1. Navegue al panel de control del servicio y pulse **Plan**. Por lo general, puede actualizar su plan o reducirlo.

...
Sie können Ihren Serviceplan in {{site.data.keyword.Bluemix}} im Dashboard für den Service ändern, falls diese Funktion für den betreffenden Service aktiviert ist.

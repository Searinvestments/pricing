...
É possível mudar seu plano de serviço no {{site.data.keyword.Bluemix}} no painel de serviço se as mudanças de plano estiverem ativadas para esse serviço.
...
plano, talvez seja necessário remontar o app e tomar ações adicionais.<br/><br/>Para remontar seu app, acesse o seu painel e localize o app ao qual o serviço está ligado. No menu do app, selecione **Reiniciar app**.<br/><br/>Outras ações de etapa subsequente dependem do serviço. Veja as ações específicas na tabela a seguir.

...
請求処理とクレジット・カードの情報を入力したら、ご使用条件に同意し、アカウント要求を送信してください。お客様のクレジット・カード情報が検証されます。また、アカウント情報の確認の E メールが送信されます。確認 E メールを受信してから数分たつと、{{site.data.keyword.Bluemix_notm}} に戻ってアプリケーションの作成を継続することができます。 
